...
namespace CodeMonkey.Utils {
    ...
    public class World_Sprite {
        ...
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, float characterSize = 1.0f, int fontSize = 30, float paddingX = 5, float paddingY = 5) {
